...
??? note "JPA и Hibernate"
    - [Сущности и репозитории](top-questions/jpa/entities-repositories.md)
    - [Жизненный цикл Entity](top-questions/jpa/entity-lifecycle.md)
    - [Первый уровень кэша](top-questions/jpa/first-level-cache.md)
    - [Связи, `Cascade`, `orphanRemoval`](top-questions/jpa/associations.md)
    - [LAZY, EAGER, `LazyInitializationException`](top-questions/jpa/lazy-eager.md)
    - [Проблема N+1](top-questions/jpa/n-plus-1.md)
    - [Пагинация](top-questions/jpa/pagination.md)
    - [Сложные запросы (JPQL, native, Criteria)](top-questions/jpa/queries.md)
    - [Оптимистичная и пессимистичная блокировка](top-questions/jpa/locking.md)
    - [`save`, `persist`, `merge`](top-questions/jpa/save-persist-merge.md)
    - [Hibernate на низком уровне](top-questions/jpa/hibernate-low-level.md)

??? note "SQL и базы данных"
    - [Уровни изоляции и аномалии](top-questions/sql/isolation-levels.md)
    - [MVCC в PostgreSQL](top-questions/sql/mvcc.md)
    - [Индексы](top-questions/sql/indexes.md)

??? note "Безопасность"
    - [Веб-атаки (CSRF, XSS, SQL Injection)](top-questions/security/web-attacks.md)
...
??? note "Kafka"
    - [Порядок сообщений](top-questions/kafka/message-ordering.md)
    - [Семантики доставки](top-questions/kafka/delivery-semantics.md)
    - [Consumer group и партиции](top-questions/kafka/consumer-group-partitions.md)
    - [Коммит offset (auto vs ручной)](top-questions/kafka/offset-commit.md)
    - [Падение консьюмера и offset](top-questions/kafka/offset-crash-scenarios.md)
    - [Долгая обработка и rebalance](top-questions/kafka/long-poll-rebalance.md)
    - [Как выбрать число партиций](top-questions/kafka/partition-count.md)
    - [Consumer lag](top-questions/kafka/consumer-lag.md)
    - [Идемпотентность потребителя](top-questions/kafka/consumer-idempotency.md)

??? note "Паттерны и согласованность"
    - [SOLID](top-questions/patterns/solid.md)
    - [Singleton, Factory, Strategy, Builder](top-questions/patterns/gof-patterns.md)
    - [Паттерны в Spring](top-questions/patterns/patterns-in-spring.md)
    - [Монолит vs микросервисы](top-questions/patterns/monolith-microservices.md)
    - [CAP-теорема](top-questions/patterns/cap.md)
    - [Eventual consistency](top-questions/patterns/eventual-consistency.md)
    - [Идемпотентность в распределёнке](top-questions/patterns/idempotency-distributed.md)
